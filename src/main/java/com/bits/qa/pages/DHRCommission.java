...
public class DHRCommission extends TestBase{
	...
	public boolean checkPeriodCommDHR(String User) throws ParseException
	{
		...
		// Check if user is on salaried or draw
		
		if(drawBtn.isDisplayed())
		{
...
//			on DRAW plan
			System.out.println("Code for draw");
...
//	  		on SALARIED plan
			System.out.println("Code for Salaried");
